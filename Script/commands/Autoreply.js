...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    ...
    "miss u too": "হুম আমি ও তোমাকে Miss করি... কিন্তু আমার বস বেশি করে 😏💖",
    ...
    "love you": "ভালোবাসা নামক আবলামী করতে চাইলে Boss Tauhid এর ইনবক্সে গুতা দিন 😘",
